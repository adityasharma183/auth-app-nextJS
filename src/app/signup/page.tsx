...
export default function SignupPage(){
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen py-2">
            ...
            />
            <button onClick={onSignup} className="p-2 mb-2 focus:outline-none focus:border-gray-600 border border-gray-300 rounded-lg ">{buttonDisabled?'NO signup':'Signup'}</button>
